        ...
        static void Main(string[] args)
        {
             ...
             do
             {
                 ...
                 if (isInputNumber)
                 {
                     ...
                     int number = HelpMethods.ConvertStringToInt(input);
                    ...
                    if (isInputInRange)
                     {
                         ...
                         HelpMethods.PrintAnyNumberUptoBillionInWords(HelpMethods.ReturnArrayStringsZeroToNineteen(), HelpMethods.ReturnArrayStringsTwentytoNinety(), HelpMethods.ReturnArrayStringsHundredtoMillion(), number);
                     }
